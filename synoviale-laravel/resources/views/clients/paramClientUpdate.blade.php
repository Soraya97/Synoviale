        ...
        <div class="row">
            ...
            <form class="col s12" action="{{route('user.update', [$user->id])}}" method="post">
                ...
                <div class="{!! $errors->has('email') ? 'has-error' : '' !!} input-field col s12 l6">
                    <input type="email" name="email" value="{{$user->person->email}}" class="validate">
                    <label for="email">Email</label>
                    {!! $errors->first('email', '<small class="help-block">:message</small>') !!}
                </div>
                <div class="input-field col s12 l6">
                    <input type="email" name="email_confirmation" placeholder="Confirmez votre email" class="validate">
